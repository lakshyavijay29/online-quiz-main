  ...
  return (
    <div className='flex flex-col items-center mt-2 gap-5'>
        ...
        <ul className='flex flex-col gap-1'>
          <li>
            Quiz must be completed in {examData.duration} minutes.
          </li>
          <li>
            Quiz will be submitted automatically after {examData.duration} minutes.
          </li>
          <li>
          ...
          <li>
            Passing marks of the quiz is <span className='font-bold'>
